...
public:
   ...
   void association( ofstream& outcomefile, ofstream& frequence_file, const double min_conf ) const;
...
protected:
   ...
   void assoc_rule_find( ofstream& outcomefile, ofstream& frequence_file, const double min_conf, set<itemtype>& condition_part,
                         set<itemtype>& consequence_part, const unsigned long union_support) const;

   virtual void assoc_rule_assist( ofstream& outcomefile, ofstream& frequence_file, const double min_conf,unsigned long actual_state,
