...
private:
   ...
   void assoc_rule_assist( ofstream& outcomefile, ofstream& frequence_file,const double min_conf, unsigned long actual_state, set<itemtype>& consequence_part ) const;
